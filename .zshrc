# Change to keep emacs from hanging in tramp mode
...
plugins=(git ruby rails bundler common-aliases)
...
source $ZSH/custom/.git-completion.zsh
...
alias res="bundle exec rake resque:work QUEUE='*'"
